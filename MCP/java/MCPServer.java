...
// Import Post_Owners_Owner_Id_EditMCPTool - included in same package
// Import Get_Owners_FindMCPTool - included in same package
// Import Get_OwnersMCPTool - included in same package
// Import Post_Owners_Owner_Id_Pets_Pet_Id_Visits_NewMCPTool - included in same package
// Import Get_Owners_Owner_Id_Pets_Pet_Id_Visits_NewMCPTool - included in same package
// Import Post_Owners_NewMCPTool - included in same package
// Import Get_Owners_Owner_Id_EditMCPTool - included in same package
// Import Get_Owners_Owner_IdMCPTool - included in same package
// Import Get_Owners_NewMCPTool - included in same package
// Import Post_Pets_Pet_Id_EditMCPTool - included in same package
// Import Get_Pets_NewMCPTool - included in same package
// Import Post_Pets_NewMCPTool - included in same package
// Import Get_Pets_Pet_Id_EditMCPTool - included in same package
// Import Get_OupsMCPTool - included in same package
// Import GetMCPTool - included in same package
// Import Get_Vets_HtmlMCPTool - included in same package
...
public class MCPServer {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Register all tools
            tools = Arrays.asList(
            Post_Owners_Owner_Id_EditMCPTool.createPost_Owners_Owner_Id_EditTool(config),
            Get_Owners_FindMCPTool.createGet_Owners_FindTool(config),
            Get_OwnersMCPTool.createGet_OwnersTool(config),
            Post_Owners_Owner_Id_Pets_Pet_Id_Visits_NewMCPTool.createPost_Owners_Owner_Id_Pets_Pet_Id_Visits_NewTool(config),
            Get_Owners_Owner_Id_Pets_Pet_Id_Visits_NewMCPTool.createGet_Owners_Owner_Id_Pets_Pet_Id_Visits_NewTool(config),
            Post_Owners_NewMCPTool.createPost_Owners_NewTool(config),
            Get_Owners_Owner_Id_EditMCPTool.createGet_Owners_Owner_Id_EditTool(config),
            Get_Owners_Owner_IdMCPTool.createGet_Owners_Owner_IdTool(config),
            Get_Owners_NewMCPTool.createGet_Owners_NewTool(config),
            Post_Pets_Pet_Id_EditMCPTool.createPost_Pets_Pet_Id_EditTool(config),
            Get_Pets_NewMCPTool.createGet_Pets_NewTool(config),
            Post_Pets_NewMCPTool.createPost_Pets_NewTool(config),
            Get_Pets_Pet_Id_EditMCPTool.createGet_Pets_Pet_Id_EditTool(config),
            Get_OupsMCPTool.createGet_OupsTool(config),
            GetMCPTool.createGetTool(config),
            Get_Vets_HtmlMCPTool.createGet_Vets_HtmlTool(config)
            );
